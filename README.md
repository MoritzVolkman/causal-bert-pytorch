...
This repository takes the Causal BERT Pytorch implementation by rpryzant and adapts it for the use with the [US election tweet database](https://www.kaggle.com/datasets/manchunhui/us-election-2020-tweets), using the #biden or #trump as treatment, the existence of both hashtags in the tweet as confounder, and whether the tweet has more retweets than average as outcome.
# Quickstart
